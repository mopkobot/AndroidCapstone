/*
 * Name: ExpandableList1
 * Purpose: Creates an explandable list so it shows all of the organizations
 */
//This code was borrowed from: http://www.edumobile.org/android/android-programming-tutorials/custom-expandable-list-example/
//I decided to use this code because it works perfectly with the campus organizations.
//I added the onChild listener, so when the user clicks on a child, the name and descroption is displayed.
package edu.Organizations;
//Imports all of the internal libraries we are using
 ...
 */
public class ExpandableList1 extends SherlockExpandableListActivity {
    ...
    //Method that handles when we click on a child
    @Override
    public boolean onChildClick(ExpandableListView parent, View v,
                                int groupPosition, int childPosition, long id) {
        // TODO Auto-generated method stub
        super.onChildClick(parent, v, groupPosition, childPosition, id);
        //Storing the position of the child and the position of the parent
        int pos_child = childPosition;
        int pos_group = groupPosition;
        //Initialize the name and the information string variable that will later be used to be passed information to the other class
        String name = null;
        String info = null;
        //Based on the child and parent position we passed the right name and information to the other organization
        if (pos_group == 0) {
            switch (pos_child) {
                case 0:
                    name = "Accounting Club";
                    info = "Accounting Club provides its members personal and professional development opportunities through education, association with business professionals, and certificationin management accounting and financial managementskills. Accounting Club practices as a respected institution influencing the concepts and ethical practicesof management accounting and financial management. \n \nAccounting Club also takes local business tours, invites individuals working in the accounting field to speak atmeetings, performs community service, raises funds for club activities and sponsors social gatherings. Accounting Club also provides resume and interviewing tips as well as networking opportunities.";
                    break;
                case 1:
                    name = "Advertising and Marketing Association";
                    info = "The Advertising and Marketing Association (AMA) providesan opportunity for individuals to learn more about business,especially in the areas of advertising and marketing.The club takes local tours, invites individuals working inadvertising and marketing to speak at meetings, takes field trips to advertising and marketing organizations outsideof the Dubuque area, performs community service, raisesfunds for club activities and sponsors social gatherings. \n \nTheir activities allow AMA members to learn companyand industry information, job descriptions, strategies forfinding jobs and internships, resume and interviewing tips and much more. Besides simply informing membersabout the business world, the interaction the organizationhas with business professionals also provides networkingopportunities for student";
                    break;
                case 2:
                    name = "American Chemical Society";
                    info = "The American Chemical Society (ACS) is the worldes largest scientific society, with more than 155,000 members. The Loras College student affiliate of the ACS is open to all students interested in the field of chemistry. \n \nThe goals of this organization are to give students the opportunity to become better acquainted with the field of chemistry, to foster a professional spirit among members, to instill a professional pride in the sciences and to foster an awareness of the responsibilities and challenges that modern chemists and scientists encounter. Activities include several social events, a volunteer chemistry tutoring program, Boy Scout Chemistry Merit Badge Day, field trips to chemical companies, chemistry shows given to local young people and trips to ACS local section and ACS national meetings. For more information, contact Dr. David Oostendorp at (563) 588-7259.";
                    break;
                case 3:
                    name = "Association for Computing Machinery";
                    info = "The Association for Computing Machinery (ACM) is a student chapter of the international scientific and educational organization of ACM. The Loras chapter and international organization are dedicated to education and informing members and non-members of issues in computers, information technology and the arts and sciences. \n \nThe main area of focus for the Loras chapter is to increase the knowledge of and interest in modern computers, and to allow a means of communication between the student members, Loras community and local businesses. For more information, contact Dr. David Oostendorp at (563) 588-7259.";
                    break;
                case 4:
                    name = "Athletic Training Club";
                    info = "Athletic Training Club is an organization that helps promote the profession of athletic training and the importance of athletic trainers in the allied health care field. \n \nThroughout the year, our club participates in athletic training related events such as volunteer medical staff at the Chicago Marathon and Preseason Prep Bowl hosted at Soldier Field. In addition, the club does several fundraisers to raise money to attend athletic training conferences, such as the National Athletic Training Association Annual Convention. Overall, Athletic Training Club helps to further the athletic training education and opportunities for athletic training experiences.";
                    break;
                case 5:
                    name = "Delta Epsilon Sigma";
                    info = "Delta Epsilon Sigma (DES) is a national honor society that is in place at Catholic colleges and universities, whose mission is to recognize academic accomplishments, foster scholarly activities, and encourage a sense of intellectual community among its members, though members need not be Catholic. Students are invited to join if they are juniors or seniors and have a GPA of at least 3.7. \n \nFaculty is invited on the basis of a nomination process, length of service to Loras and contributions to the lives of students and to the academic atmosphere. Lorase chapter, Alpha, provides peer tutoring, assists with the Multicultural Family Center, co-sponsors a literary publication with the English program (The Limestone Review), and sponsors a writing contest each year. In addition, the national office offers several scholarships and other awards to qualified members. For more information about The Limestone Review, contact Dr. Elizabeth Raschke at (563) 588-7200. For other matters pertaining to the society, contact Dr. Matthew Garrett at (563) 588-7165.";
                    break;
                case 6:
                    name = "Economics Club";
                    info = "The Economics Club is an organization for economics majors, minors and anyone interested in how economics affects local, national and international issues. The club brings the teaching of economics at Loras to the world around Dubuque. Activities include speakers and discussions on current economic topics, field trips and social gatherings plus a variety of campus functions. \n \nMembers of the Economic Club also volunteer as tutors for students in the introductory economics courses. For more information, contact Dr. Laddie Sula, faculty advisor, at (563) 588-7507. Please also consult the Economics Club webpage.";
                    break;
                case 7:
                    name = "Engineering and Physics Club";
                    info = "The Engineering and Physics Club is an organization open to all members of the Loras College community. A focus of the club is to aid engineering and physics students with their yearly projects. The club tours local companies that might employ Loras College graduates as well as other campuses that are of interest to members of the club. \n \nAdditional activities include recruiting presenters for lectures of interest for the group as well as fundraising. The club members attempt to enter at least one engineering design contest each year for the students to gain real-world engineering experience. The club maintains an eLearn site with member information and a schedule of events. For more information or to be added to the eLearn site, contact the club advisor, Dr. Clark Merkel, at Clark.Merkel@loras.edu.";
                    break;
                case 8:
                    name = "Financial Management Association";
                    info = "The Financial Management Association (FMA) was created to: (1) assist in the professional, development of college students interested in finance, banking and investments; (2) provide networking opportunities for students interested in these fields with business professionals, faculty and other students; and (3) enhance knowledge about and provide opportunities relating to careers in finance. \n \nThis is accomplished through activities including regular organization meetings, on and off campus speakers, trips and company tours and social and professional gatherings. For more information contact John Upstrom at John.Upstrom@loras.edu. ";
                    break;
                case 9:
                    name = "Future Educators of Loras College";
                    info = "The Future Educators of Loras College provides students interested in becoming educators with information and support as they go through the program as well as offering resources and advice within the Dubuque Community School District. \n \nWe offer multiple opportunities for students to learn about the requirements to be accepted, when to start sending out your resume, job fair information, as well as offering a student teaching panel to provide first-hand knowledge to student questions.";
                    break;
                case 10:
                    name = "Health Science Club";
                    info = "The Health Science Club is a campus organization open to everyone, especially those interested in the health sciences. The Health Science Club holds monthly meetings during which service, social, fundraising and educational programs are discussed. \n \nService activities include volunteering with Dance Marathon, Hills and Dales, the Dubuque Regional AIDS Coalition, MDA, March of Dimes, blood drives and blood pressure checks. Fundraising opportunities range from selling t-shirts to candy bars. The programming committee arranges speakers to talk to students. Ophthalmologists, optometrists, chiropractors, radiologists, podiatrists, veterinarians, medical students, medical researchers, physician assistants, physical therapists, dentists and other health care professionals have come to campus to talk about their jobs, training and lifestyles. Furthermore, there are a variety of social activities. The Health Science Club aims to provide information and answer questions for important career decisions in the health field. For more information, contact Dr. Tom Davis at (563) 588-7767.";
                    break;
                case 11:
                    name = "Loras Alternative Dispute Resolution Society";
                    info = "Loras Alternative Dispute Resolution Society (LADRS) is a chapter of the International Alternative Dispute Resolution Society, an organization for professional mediators across the globe. LADRS members make up the Loras College Mediation Team which competes in regional and national tournaments as well as several invitational tournaments throughout the fall semester. \n \nThe goal of LADRS is to educate students about negotiation, a necessary skill in the workplace environment. LADRS members are trained in mediation and dispute resolution techniques and are taught a number of times during the year to maintain skills and also observe professional mediators in their trade. For more information, contact Ron.Collins@loras.edu.";
                    break;
                case 12:
                    name = "Loras College Mediation Team";
                    info = "The Loras College Mediation Team works on peaceful conflict resolution and attends a regional conference and tournament in October in Wisconsin and the National Conference and Intercollegiate Championship Tournament in mid-November in Chicago. \n \nLoras is currently ranked among the top ten teams in the U.S. in the past five years. For more information, contact Professor Mary Lynn Neuhaus, J.D., 421 Hoffmann Hall.";
                    break;
                case 13:
                ...
                case 14:
                    ...
                    info = "Student teams participate in simulation of a legal argument before an appellate court. Teams prepare a legal brief on the real constitutional issues presented in the hypothetical case and present it in oral argument before a panel of judges at a regional and national intercollegiate tournament. \n \nThe regional tournament takes place in November, with the national championship tournament in January. Moot Court emphasizes understanding and applying legal reasoning and argumentation, and it also refines persuasive writing and speaking skills. Students interested in law are encouraged to participate. For more information, see Professor Christopher Budzisz, Ph.D., 540 Hoffmann Hall, christopher.budzisz@loras.edu.";
                    break;
                case 15:
                    name = "Loras Philosophy Club";
                    info = "The Loras Philosophy Club provides students an opportunity to engage in critical thinking about philosophical issues. In todayes society, there is more need than ever to develop onees mind and ability to reason. Complicated issues arise constantly in the form of ethical dilemmas about abortion, euthanasia, genetics, politics and education; and many ancient metaphysical questions remain debated on topics such as truth, existence, human nature, art and God. \n \nTo be knowledgeable and conversant in these and other fields and issues is the hallmark of a well-educated person. The Loras Philosophy Club provides opportunities for participating in informal discussions (often spirited), viewing films, lectures and field trips, all in the interest of learning more about philosophical issues relevant to the times and situations in which students find themselves. For more information, contact Brandon Schetgen at Brandon.Schetgen@loras.edu.";
                    break;
                case 16:
                    name = "Loras Students for Inclusive Education";
                    info = "Loras Students for Inclusive Education is an active, professional group of students who are interested in expanding their knowledge of current issues in special education with a focus on educational practices to fully include all students in the general education setting. \n \nThe purpose of LSIE is for students who plan to become teachers specializing in early childhood, elementary, secondary, or special education to explore educational issues and apply what is learned in the community to promote inclusion. LSIE is also a scholarly and service based organization. Interested students may get in touch with our president, Chrissy Fischer, at Christine.Fischer@loras.edu or our advisor, Janine Kane, at Janine.Kane@loras.edu";
                    break;
                case 17:
                    name = "Loras Math Club";
                    info = "The Loras Math Club is an organization of students and faculty/staff members who enjoy the same love for mathematics. During the school year, the Math Club is involved in a number of social events, including Thursday Nights at the Heidenreiches, where we study, snack and play games at our professores home. \n \nThe Club is also involved in t-shirt fundraisers, and has done several service projects with children of the Dubuque community. The Math Club travels to math conferences to see what others are studying and to present their own topics. The Club also holds a eRegressive Dinnere each semester at the homes of various professors and students. The members are able to go on trips related to their interest. The Math Club is not just for math majors, but is for anyone who enjoys math. For more information, contact Dr. Jacob Heidenreich at Jacob.Heidenreich@loras.edu or (563) 588-7793.";
                    break;
                case 18:
                    name = "Paideia";
                    info = "Paideia is the name of the organization for students and faculty who participate in the Honors Program. Paideia seeks to build community within the Honors Program through social activities and community service, as it contributes to the life of the College through a range of campus programming. \n \nPaideia brings in speakers, hosts movie and book discussions, organizes student research presentations and facilitates the participation of students in off-campus academic events such as conferences. For more information, contact John Eby at (563) 588-4929 or john.eby@loras.edu.";
                    break;
                case 19:
                    name = "Phi Beta Lambda";
                    info = "Phi Beta Lambda is an education association with a quarter million students preparing for careers in business and business-related fields. PBL is the largest business career student organization in the world. The postsecondary division reaches over 11,000 college students. \n \nThrough state-based competition at the spring State Leadership Conferences, students compete in events testing their business knowledge and skills. Top state winners then are eligible to compete for honors at the National Leadership Conference each summer. Contact Professor Mathew Keyes for more information at Mathew.Keyes@loras.edu.";
                    break;
                case 20:
                    name = "Physical Education & Sports Studies Majors Club ";
                    info = "The clubes mission is to join students of the Athletic Training, Physical Education, Sport Management and Sport Science majors within the Physical Education and Sport Studies Division. Learning is not just done in the classroom, so we offer this club as an outside learning tool through social activities, meetings, service projects, speakers and conventions. \n \nDuring the 2009/2010 school year the club ran a successful Monday Night Football bags tournament, had members go to Cleveland, Ohio, and Chapel Hill, N.C., for case study competitions, and held a Grassroots Soccer Tournament to support the cause against AIDS in Africa. The club aims to help student funding throughout the program in the upcoming year with hopes to send students to the IAHPERD conference in November and case study competitions in New Orleans, La., and Chapel Hill, N.C. These outside learning programs will further enhance the total physical education/sport experience. Our club is here to help Loras College produce multifaceted educated students. The club will incorporate current issues, past ideas from alumni and records to help our studentse learning process here at Loras College. As reads in the Loras College Student Handbook, eextracurricular activities and clubs are here to better the total development and growth of the student.e We intend to offer added knowledge to the students in a fun, energetic and exciting manner. For more information, contact Matt Garrett at (563) 588-7165.";
                    break;
                case 21:
                    name = "Social Work Club";
                    info = "The Social Work Club is a way for all students to become involved in a wide variety of service opportunities. We strive to create change both on campus and in the community. The club helps sponsor activities such as Sleepout Dubuque and the Giving Tree program. \n \nOther activities we are involved in include the Candlelight Vigil for domestic violence, Special Olympics, the Big Brother/Big Sister Program, serving meals at Hope House, poverty simulations, visiting nursing homes and much more. In this organization, there are not simply opportunities to complete service, but also chances to meet new people, learn leadership skills and have fun at the same time! This organization is open to non-majors as well. For more information contact the Social Work Clubes advisor, Nancy Zachar Fett, at (563) 588-7029.";
                    break;
                case 22:
                    name = "The St. Thomas More Pre-Law Society";
                    info = "The St. Thomas More Pre-Law Society is a student organization intended for those students who are considering law school in the future. The Pre-Law Society provides opportunities to attend law school visits in the surrounding area, brings speakers from law school admissions boards to talk to students about the application process, and also offers many networking opportunities with legal professionals in the Loras and Dubuque communities. \n \nThe society has volunteered for the Dubuque Mental Health Association and participated in the Clean-Up Dubuque project in the past years. The objectives of the St. Thomas More Pre-Law Society are to:- Help members make informed decisions about whether or not to attend law school- Help members choose which law schools to apply- Decode the law school admissions process- Expose members to various legal fields and introduce them to different options they have with a law degree- Help members register for the Law School Admissions Test (LSAT)The advisor for the Pre-Law Society is Deone Merkel, please contact deone.merkel@loras.edu.";
                    break;
                case 23:
                    name = "Writerse Ink";
                    info = "Writerse Ink is a group for those interested in writing anything, including poetry, novels, and anything in between. The group provides feedback, strategies, and critique for anyone who may have writeres block, and it also tries to help young writers get editing and publishing information, so that one day they may see their works in print. Writerse Ink has regular workshops and meetings, poetry and short story readings, and visiting authors and speakers, who share tips about getting started and the writing process. \n \nThe group also participates in multiple community service projects, including book drives and reading events. For more information contact Susan Stone at susan.stone@loras.edu.";
                    break;
            }
            ...
            switch (childPosition) {
                case 0:
                    ...
                    info = "The Loras College Cheerleading Squad performs at home football games and home basketball games for the men and women. Membership is open to first year students, sophomores, juniors and seniors and is determined through a etry-oute selection process. Students who participate in the Cheerleading program must maintain the minimum GPA established by the Student Life Office and must participate in all activities assigned by the groupes advisor. For more information, contact the Athletic Department at (563) 588-7742. ";
                    break;
                case 1:
                    name = "Duhawk Dancers";
                    info = "Loras Collegees dance team is the Duhawk Dancers. This group of Loras women performs dance routines for audiences during football, womenes basketball and menes basketball games. Membership is open to first year students, sophomores, juniors and seniors and is determined through a etry-oute selection process. Students who participate in the Duhawk Dancers must maintain the minimum GPA established by the Student Life Office and must participate in all activities assigned by the groupes advisor. For more information, contact the team via the Athletic Department at (563) 588-7742. ";
                    break;
                case 2:
                    name = "Intermurals";
                    info = "Loras College is dedicated to the total development of the student. The intramural department strives to develop the student through a variety of recreational activities where participation is more important than winning. This participation has not only included the student body, but also faculty, staff, administrators and their families. Loras provides a highly organized and thoroughly developed supervised intramural program, which includes leagues, Sunday tournaments, and Friday events. \n \nAll event winners receive a Loras College Intramural Champion t-shirt and at the end of the school year, an overall male, female, and faculty/staff eIntramural Athlete of the Yeare award is presented. Over 600 participants compete in one or more of the 50 plus activities. For more information, contact Teresa Kehe, director of intramurals, at imoffice@loras.edu or (563) 588-7459.";
                    break;
                case 3:
                    name = "Judo Club";
                    info = "Judo is concerned with throwing and mat techniques, including chokes and armbars. It can be learned and practiced by both women and men. Physical size is not a limiting factor. Judo is an excellent means of self defense. Judo increases flexibility, coordination, balance, self- confidence and improves your physical condition. In Judo you may compete against other people at tournaments across the Midwest (competition is optional). No previous experience required. Experienced Judoka are welcomed. \n \nPractice is only two nights a week (Tuesday and Thursday) from 7:15-9:15 p.m. and may be taken for a credit or just for fun. Judo is a physical contact sport. Safety is stressed in classroom teaching. Therefore you assume your own risk in participating. Practices are in 208 Graber Sports Center (wrestling room). Wear workout clothes. For more information, contact Terry Smith at (563) 556-2352. ";
                    break;
                case 4:
                    name = "Loras Cycling Club";
                    info = " The Loras Cycling Club is open to all Loras students who wish to further their knowledge and interest in bicycling. The purpose of the Loras Cycling Club is to provide an organized body to help promote an interest in bicycling for all students, faculty, and staff at Loras College. The club shall focus on bicycling in all its forms without an emphasis on a particular aspect, and all variants of riders are welcome to join, whether you be an avid racer or someone looking for a leisurely ride with other enthusiasts.e \n \nFor information, contact Dr. Kevin Koch, at (563) 588-7536 or via email at Kevin.Koch@loras.edu.";
                    break;
                case 5:
                    name = "Loras Hockey Club";
                    info = "The Loras Hockey Club, founded in 1981, is an organization open to all Loras College students, regardless of their skill level or gender. The club provides its members an opportunity to play competitive hockey in an atmosphere that produces many memorable friendships and experiences. The hockey season runs from October through March, and consists of numerous on and off-ice practices and approximately 12 games. The first game of the year takes place during Homecoming weekend at Loras against a team consisting of Loras alumni. \n \nAll other games are played against teams from the Midwest, such as Cornell College and the University of Wisconsin-Platteville. The season ends with a second game against a team consisting of Loras alumni, this time in Chicago, Illinois. For more information, contact the clubes advisor, Professor Roman T. Ciapalo at (563) 588-7434.";
                    break;
                case 6:
                    name = "Loras Ultimate Club";
                    info = "Loras Ultimate Club is an up and rising club in its second year on campus. We are an Ultimate Frisbee team that plays for the pure enjoyment of Ultimate and also play competitively in tournaments under the Ultimate Players Association (UPA) College league. We consist of students of all ages and we do not turn anyone away. No experience is necessary and we will teach the basics such as throwing techniques, catching and cutting as well as fundamentals in offense and defense. \n \nAny questions contact Jordan Metz at Jordan.Metz@loras.edu, Matt Rissler at Matthew.Rissler@ loras.edu or Andrew White at Andrew.White@loras.edu.";
                    break;
                case 7:
                    name = "Student Athlete Advisory Committee";
                    info = "The Student Athlete Advisory Committee (SAAC) is a student organization comprised of student-athletes. Two representatives from each conference recognized sport are involved in the committee. This organization meets regularly to plan events that aid in achieving their goals and enhance the total student athlete experience. As a NCAA Division III and IIAC institution, the committee is active with NCAA and IIAC issues and discussions. This organization serves as a great liaison between student athletes and the athletic department. \n \nIn addition to its official duties as an organization, SAAC also sponsors service and volunteer opportunities such as take a kid to the game, campus clean- up and working NCAA/IIAC Championships Loras may host. The committee is advised by the Associate Athletic Director.";
                    break;
                case 8:
                    name = "Varsity Athletics";
                    info = "The Loras College Department of Athletics is affiliated with the NCAA Division III and is a member of the Iowa Intercollegiate Athletic Conference. For further information, contact the Department of Athletics at (563) 588-7112. Men: Loras offers 11 varsity sports for men which are baseball, basketball, cross-country, football, golf, soccer, swimming and diving, tennis, indoor track and field, outdoor track and field and wrestling. \n \nWomen: Loras offers 10 varsity sports for women, which are basketball, cross-country, golf, soccer, softball, swimming and diving, tennis, indoor track and field, outdoor track and field and volleyball.";
                    break;
            }
            ...
            switch (childPosition) {
                case 0:
                    name = "KLCR";
                    info = "KLCR is Loras Collegees own student-operated radio station, offering a variety of opportunities to students interested in exploring the world of radio. KLCR is broadcast online at www.KLCR.org. KLCR is completely student run. Its daily operations are run by a student board of directors in the following positions: general manager, program director, music director, advertising director, public relations director and technical director. \n \nThose with interest may be involved in any aspect of the station, from management to production and from public relations to just playing music. Experience is not necessary, just enthusiasm. For more information contact Paul Kohl at Paul.Kohl@loras.edu or or Allison Zelesny at Allison.Zelesny@loras.edu.";
                    break;

                case 1:
                    name = "LCTV";
                    info = "Loras College Television (LCTV) is the campus television station run entirely by students. You can tune in on Channel 13 on campus or on digital Channel 97.5 in Dubuque. LCTV students produce newscasts, sportscasts, live broadcasts of home basketball, football and soccer games, documentaries, commercials and various other productions. LCTVes shows are recognized every year among the top in Iowa and the best in the nation. You can check us out at myduhawk.com. \n \nAnyone can get involved with LCTV at any time during their college career. For more information, call (563) 588-7032 or (563) 588-7385 or e-mail lctv@loras.edu. ";
                    break;
                case 2:
                    name = "Limestone Review";
                    info = "The Limestone Review is the Loras College literary/ scholarly-essay magazine, published once a year, featuring fiction, poetry, creative nonfiction and scholarly essays. Students may become involved by submitting work and/or by participating on the Reading/Selection Committee in the spring semester. The literary/scholarly publication is co- sponsored by the English Program and Delta Epsilon Sigma. \n \nFor information, contact Dr. Kevin Koch, at (563) 588-7536 or via email at Kevin.Koch@loras.edu.";
                    break;
                case 3:
                    name = "Lorian";
                    info = "The Lorian, the Loras College student newspaper, is a main source of campus communication. Published weekly, the newspaper includes news, features, sports, editorials and advertisements. The student staff at The Lorian attempts to provide quality coverage of social, academic, athletic and religious areas of the Loras community. An online version of The Lorian also attempts to maintain contacts with alumni and friends of the College. \n \nThe Lorian staff consists of about 40 students. Positions available include executive editors, section editors, assistant editors, reporters, advertising representatives, photographers and columnists. For more information, call the Lorian office at  (563) 588-7954 or stop in the Lorian office, 259 Hoffmann Hall. No experience is necessary.";
                    break;
                case 4:
                    name = "Purgold";
                    info = "Lorase yearbook, The Purgold, first published in 1925, is the printed ememory booke of the Loras community. The yearbook works to represent Loras history, culture, organizations, sports and people. Each year the staff strives to create a better representation of Loras College with the publicationes design, photographs, information, stories and quotes. It is really the eface booke of Iowaes oldest college. For the past several years, the Purgold has received the prestigious Walsworth Publishing Gallery of Excellence Award. \n \nWith this honor, the publication will be found all across the country as an example of excellence for yearbook staffs. The Purgold is looking for students who are dedicated, work hard, excited for a challenge and ready to capture life at Loras College that will someday become cherished memories. Opportunities on the staff include committee members, photography, journalists, layout/design and editing. It is encouraged for applicants to have past yearbook experience and/or past software experience with Adobe InDesign and Photoshop. For more information and job applications, call Mike Gibson, advisor, at (563) 588-7163, email Michael.Gibson@loras.edu or stop by his office, 154 Academic Resource Center. ";
                    break;
            }
            ...
            switch (childPosition) {
                case 0:
                    ...
                    info = "119 Keane Hall e (563) 588-7104";
                    break;

                case 1:
                    name = "Campus Ministry";
                    info = "460 Alumni Campus Center e (563) 588-7650" + "\n" + "The offices of Campus Spiritual Life and Campus Ministry serve the entire Loras community by reminding us that each of us are spiritual beings and we need to pay attention to our spiritual lifeeno matter where we are on our faith journey. Regular opportunities for participation in the celebration of Eucharist, Adoration of the Blessed Sacrament, other forms of praise and worship, preparation for and reception of the sacraments, and spiritual development through retreats, service to the community, and activities that foster a close relationship with Christ are planned and implemented by student coordinators and student-led leadership teams. \n \nPrograms for spiritual enrichment, service learning (service trips), and social justice, assist students in developing a greater understanding of the complexities of our call as Christians to transform the world. Students assume leadership roles by leading retreats or service trips, teaching and tutoring in local parishes and schools, and through involvement in various committees and planning teams. Campus Ministry also invites the participation of faculty, staff, and administration in these activities. CORE Team e The Campus Ministry CORE Team was organized to provide an opportunity for a representative group of students from the Loras Community to plan, coordinate and evaluate the activities and programs sponsored by Campus Ministry. CORE Team builds Community on campus, encourages Outreach and service to others, as well as, Reflection and prayer, and Empowers Loras community members to share their gifts! CORE assists with epastoral planninge for our faith community. This is primarily about prayer, compassion, hospitality and discipleship. To become involved in CORE Team events and activities, contact Director of Campus Ministry Colleen Kuhl at (563) 588-7924 or Colleen.kuhl@loras.edu. Discovery Retreat Teams e Teams of 25-30 Loras students are formed and trained to facilitate day-long confirmation retreats for high school students involved in Catholic Confirmation preparation programs around the archdiocese of Dubuque. Four retreats are given each year for 80-90 confirmation students each time. Contact Campus Minister Debbie Gross at (563) 588-7934 or  Debbie.gross@loras.edu. Service Trip Teams e Throughout the year, Loras sponsors approximately nine service trips to various parts of the United States (Cedar Rapids, Chicago, New Jersey, New Orleans, Washington, DC, Kentucky) and Haiti and Honduras. Grounded in the foundation of Catholic Social Teaching, teams are selected through an application process open to all students; and are accompanied by a student coordinator and a faculty, staff or alumnus accompanying adult. If you are interested in applying for a service trip team, contact Director of Campus Ministry Colleen Kuhl at (563) 588-7924 or Colleen.kuhl@loras.edu. ";
                    break;
                case 2:
                    name = "Office of Worship";
                    info = "eThe Bridgee e 100 Christ the King e (563) 588-7303 e david.summers@loras.edu" + "\n" + "Communal worship is central to the life of Catholic Christians, and people of any faith tradition are invited and welcome to participate as much as they are able. Opportunities for those of faith traditions other than Catholic are available through contacts with local congregations, and some on-campus events. \n \nAll campus worship is always open to everyone and need neither preparation nor registration. Call the Loras College Mass Hotline  (563) 588-7770 or call Office of Spiritual Life, (563) 588- 7104, for the current schedule and locations. To become involved in any of the following liturgical opportunities, contact the Dean of Campus Spiritual Life or Liturgy Coordinator David Summers at (563) 588-7303 or  david.summers@loras.edu. Sunday Eucharist e Christ the King Chapel 8:00 p.m.  Daily Eucharist e Christ the King Chapel  Monday, 5:15 p.m.  Tuesday, 5:15 p.m.  Wednesday, 12:20 p.m. and 9:00 p.m. (usually a more casual celebration than Sunday, these celebrations are a great mid-week time to gather for faith, fellowship and relaxation) Thursday, 5:15 p.m.  Friday, 5:15 p.m. Daily Eucharistic Exposition and Adoration St. Joseph Adoration Chapel (Hoffmann Hall) Monday-Thursday 9:00 a.m. e 5:00 p.m.  Friday, 9:00 a.m.-4:00 p.m.  Exposition, Benediction and Confession Thursdays, 9:00-10:00 p.m., Christ the King Chapel Reconciliation  The Celebration of Reconciliation (Confessions) takes place one-half hour prior to every weekday and weekend Mass, as well as Thursdays during the Holy hour at  9:00 p.m., in Christ the King Chapel. Individuals can also schedule appointments if those times are not convenient. Please call Office of Spiritual Life (563) 588-7104. Advent/Lent Communal Reconciliation Services, see current bulletin. Worship Team e Meeting bi-weekly, this team plans weekend worship in advance. Activities include study and discussion of weekend Scripture readings, brainstorming homily themes and their relationship to music. Included in the planning are any seasonal celebrations, selection of liturgical music, seasonal chapel environments, planning reconciliation services, Morning Prayer, Eucharistic Adoration, Fall Welcome Mass, Homecoming, Family Weekend, Baccalaureate and other major liturgical observances of the College. Open to everyone, this group is run by the Dean of Spiritual Life and Liturgy Coordinator who are assisted by the Head Sacristan, a student worker, and consists of students with an interest in the Liturgy or who wish to learn more about planning Worship. The Worship Team also has the responsibility of scheduling and training Liturgical Ministers.  Liturgical Music Ministry e A large number of student musicians regularly participate in accompanying/leading congregational, instrumental and vocal music for worship at Loras College. All instruments and voices are welcome! eThe Chapel Ensemblee rehearses weekly for bi-weekly Sunday Liturgies. Practices for all other Masses are held an hour and a half prior to the start of Worship. Open to anyone of any talent, ability or denomination who is willing to rehearse and practice music. Contact the Liturgy Coordinator, David J. Summers for further information at (563) 588-7303, or at david.summers@loras.edu. Liturgical Ministries e Worship at Loras College is on the move! Students are encouraged to become more active in the celebrations through their participation in liturgical ministries. Opportunities within the Sunday and weekday celebrations of the Eucharist include: greeter/ hospitality (welcome people to Loras worship); lector (proclaim Scripture readings); Eucharistic minister (assist in distributing Holy Communion); acolytes (serve in the sanctuary at the altar); sacristan (prepare vessels, hosts and wine for Eucharistic celebrations). Some (but not all) of these ministries are open to people of any denomination. Contact the Liturgy Coordinator, David J. Summers to find out how you can get involved at (563) 588-7303, or at  david.summers@loras.edu. Religious Opportunities for Students from Other Faith Traditions e Loras College believes that every person is spiritual and deserves opportunities to grow in his/her faith. Current initiatives on campus are planning events for other Christian and non-Christian students. Chapels/sacred space are available for respective traditions. Loras College is committed to the spiritual development of all students, faculty and staff. If you would like more information about ecumenical or interfaith initiatives at Loras, or other worship opportunities in Dubuque, contact Director of Campus Ministry Colleen Kuhl at (563) 588-7650 or  Colleen.kuhl@loras.edu. Spiritual Direction e Offers an opportunity to journey with someone in discussing your spiritual life. Usually meeting bi-weekly, participants bring their reflections from prayer and their concerns of how God relates to challenges in their lives. One-on-one meetings with the spiritual director provide a listening ear, as well as someone with whom they  can be accountable in their prayer/spiritual life. Note that this is not a counseling situation, nor merely an advice session. Content of the meetings arises from the participantes prayer life and his/her attempts to integrate God into his/her personal experience. A great experience for anyone wanting to grow in his/her faith and discern Godes plan in life. Open to anyone. Somewhat limited spaceefirst come, first serve. For more information, contact Director of Campus Ministry, Colleen Kuhl at (563) 588-7650 or colleen.kuhl@loras.edu. Religious Vocations Discussion Group e Meets monthly, informally to discuss questions regarding vowed, religious and ordained ministry in the Church. The eno-strings- attachede approach lets individuals explore their interests and concerns regarding religious vocations. Various opportunities for ministry are explored and topics related to vocational discernment discussed. Meals and social gatherings provide the context for some great discussions. Open to men and women- separate meeting opportunities available. For more information, contact Dean of Campus Spiritual Life the Rev. William Joensen at (563) 588-7108 or Director of Campus Ministry, Colleen Kuhl at  (563) 588-7650.";
                    break;
                case 3:
                    name = "Father Ray Herman Peace and Justice Center";
                    info = "Father Ray Herman Peace and Justice Center 460 Alumni Campus Center e (563) 588-7650" + "\n" + "The Peace and Justice Center serves as a focus for social justice activities on the Loras campus, as well as connecting with justice advocacy in the Dubuque community. Established in the memory of Fr. Ray Herman, an archdiocesan priest who was martyred in 1975 as he ministered to the poor in Morachata, Bolivia, the Center serves as both a resource center and a program effort which helps to remind the Loras community of our call and commitment to justice, serving the poor, and increasing our awareness of the social teachings of the church on all levelselocal, national and global. \n \nFather Ray Herman Peace and Justice Community e The Peace and Justice Community is a campus group that meets weekly to discuss social justice issues, raise global and local service and social justice awareness, advocate for peace and sponsor charity and service-related fundraising projects. Members of the community educate themselves on global issues related to social justice, in addition to learning more about the social teachings of the church. Peace and Justice members strive to act on the knowledge they have, often taking part in serving meals at Hope House, the local Catholic Worker; engaging in peaceful demonstrations on and off campus; and taking part in campus clean-up days, as well as educating other members of the campus community on social justice issues. For more information, or to get involved, contact David McDermott, Peace and Justice Coordinator, at  David.McDermott@loras.edu, or (563) 588-7056. ";
                    break;
                case 4:
                    name = "FOCUS";
                    info = "18 Rohlman e (563) 588-7044" + "\n" + "An affiliate of the national program, the Loras FOCUS missionaries offer small group Bible studies on campus, leadership training in our one-on-one mentoring program (discipleship) and host various large group events. FOCUS is committed to helping students grow in their relationship with Jesus Christ and an understanding of the Catholic faith, while providing encouragement in studentse studies, social lives, dating relationships and major life decisions. \n \nTo get involved in FOCUS activities, contact the FOCUS team director at (406) 600-1509 or loras@focusonline.org.";
                    break;
            }
            ...
            switch (childPosition) {
                case 0:
                    ...
                    info = "The Loras Student Union (LSU) is the student governing organization of Loras College. This tri-cameral structure includes the College Activities Board (CAB), Residence Hall Association (RHA) and Student Senate. These three branches work together to enhance and improve all aspects of college life for Loras College students, including programming, governance and residence life. Additionally, the Loras Student Union includes three Constitutional Councils which connect the three branches and encourage cooperation and collaboration between all areas of government. \n \nThese Councils include the Organizational Union (OU), Residence Life Programming and the Student Life Council. ";
                    break;

                case 1:
                    name = "Campus Pride";
                    info = "Campus Pride is for those at Loras who would like to see more school spirit and higher attendance at athletic events (as well as non-athletic events such as plays). Campus Pride got bigger in the e09-e10 school year, as the organization received $3,000 from the Student Union. The money was used to purchase eDuhawk Natione t-shirts that were handed out to the students to wear at events. The organization also purchased a eDuhawk Natione banner which will be placed in the student section at athletic events, and organized a halftime competition at basketball games. \n \nIn the future, Duhawk Nation looks to contribute more shirts, provide more memorabilia for fans and get students more involved with events, and much, MUCH, more.";
                    break;
                case 2:
                    name = "College Activities Board";
                    info = "The College Activities Board (CAB) is a student-run organization. CABes goal is to bring diverse entertainment, speakers, movies, cultural activities and numerous other events to campus. CABes budget comes from student fees, so it is committed to hosting events that students voice interest in. CAB provides quality activities throughout the year for the campus to enjoy. CAB has hired positions as well as committees consisting of any interested students. Participation in CAB is welcome and encouraged! \n \nFor more information, contact the CAB office at college.activityboard@ loras.edu or (563) 588-7203 or Michele Nauman at  (563) 588-7731. ";
                    break;
                case 3:
    ...
    public class MyExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        //Returns the child from a array
        ...
        //Gets a count of how many children are in the array
        public int getChildrenCount(int groupPosition) {
            return children[groupPosition].length;
        }

        //Configures the expandable list
        ...
        //Method that returns the view of the children in the expandable list
        ...
        //If the child is selected returns true
