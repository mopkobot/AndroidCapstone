...
/* This class is used to list the information for each of the different states. It is a numerous amount of text information
* concatenated together. These separate text lines are what fill into the public constructor located in State.java
* when a new state is declared in this class. 
* If a new state wanted to be added or deleted that is listed in the Directions.java class, it would be done here.
* 
* Sources Cited: depts.loras.edu/hr/directions.html
* 
* Coded by: Jake Pfohl
*/
